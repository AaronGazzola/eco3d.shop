...
- [ ] 5.7 Apply the angle-cap decision once the owner rules on it. Recommendation recorded in §7: one cap per region (head 21°, trunk 32°, tail 40°) replacing the bumpy per-joint set, which contains a 22° dip at joint 7 between neighbours of 28° and 30° that is currently capping the whole wave. Not applied here — the caps live on the rig, and whether they encode the printed model's real range is the owner's knowledge. If they are physical, the ceiling for a uniform wave is about 22°.
