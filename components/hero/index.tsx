...
import { SquareMousePointer, ShoppingBasket, Pencil, Ruler } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 text-left text-white space-y-6">
          <div className="max-w-[520px]">
            ...
            <button className="bg-primary hover:bg-white text-white text-[14px] px-6 py-3 mt-8 rounded-full">
              Get Started
            </button>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 -right-1 transform translate-y-6">
              ...
              <Image
                ...
                height={30}
                width={30}
                className="absolute bottom-0 sm:bottom-[5.2rem] md:-bottom-[-7rem] left-[7.1rem] md:left-[8rem] rotate-[-170deg]"
              />
            </div>

            <div className="absolute top-[9.5rem] -left-10 transform translate-y-6">
              <Annotation
                icon={<Ruler />}
                label="Customise"
              ...
              <Image
                ...
                height={30}
                width={30}
                className="absolute bottom-0 -z-0 sm:bottom-[-5.2rem] md:-bottom-[5.2rem] left-[7.8rem] rotate-[-90deg]"
              />
            </div>
          </div>
        </div>
