...
export function CalibrateTab() {
  ...
  const handleSave = useCallback(() => {
    if (!variantId || !stage) {
      console.error('Cannot save a rig before a variant and stage are chosen in the Pick step')
      return
    }
    saveRig()
  }, [variantId, stage, saveRig])
  ...
  const canSave = !!stlKey && !!variantId && !!stage && !saving
